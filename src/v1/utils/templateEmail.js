...
var that = module.exports = {
  ...
  `,
  sendTokenResetPassword: (token, name='there') => `
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
      <head>
          <meta http-equiv="Content-type" content="text/html; charset=utf-8"/>
                                                  ...
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      ...
                                                      <tr>
                                                          <td style="font-size:14px; color:#636E72; min-width:auto !important; line-height: 20px; padding: 0 32px 32px;">
                                                              ...
                                                              <br/>
                                                              <a href="${process.env.LINK_RESET_PASSWORD+token}" target="_blank" style="color:#ffffff; background: #0010F7; border: 1px solid #0010F7; border-radius:8px; display: inline-block; margin-top: 8px; padding: 12px 22px; text-decoration:none;">
                                                                  Reset password
                                                              </a>
                                                          </td>
                                                      </tr>
  ...
  `,
  sendMailToRegisterSeller: (token, name='there') => `
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
      <head>
          <meta http-equiv="Content-type" content="text/html; charset=utf-8"/>
                                                  ...
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      ...
                                                      <tr>
                                                          <td style="font-size:14px; color:#636E72; min-width:auto !important; line-height: 20px; padding: 0 32px 32px;">
                                                              ...
                                                              <br/>
                                                              <br/>
                                                              <a href="#" target="_black" style="text-decoration: none; color: #0010F7;">${process.env.LINK_REGISTER_SELLER+token}</a>
                                                              <br/>
  ...
  `,
  sendMailOrderSuccess: ({name, orderId, totalPaid, totalShippingCost}) => `
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
      <head>
          <meta http-equiv="Content-type" content="text/html; charset=utf-8"/>
  ...
  `,
  sendMailActiveAccount: ({token, name}) => `
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
      <head>
          <meta http-equiv="Content-type" content="text/html; charset=utf-8"/>
                                          ...
                                          <tr>
                                              <td style="border-radius: 8px;" bgcolor="#ffffff">
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                          <td style="font-size:24px; color:#0010F7; min-width:auto !important; font-weight: bold; padding: 32px 32px 0;">
                                                             Please access the link to active account 📮
                                                          </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                          <td style="font-size:14px; color:#636E72; min-width:auto !important; line-height: 20px; padding: 32px;">
                                                              ...
                                                              This link will expire in 24h and can only be used once.
                                                              <br/>
                                                              <a href="${process.env.LINK_ACTIVE_USER+token}" target="_blank" style="color:#ffffff; background: #0010F7; border: 1px solid #0010F7; border-radius:8px; display: inline-block; margin-top: 8px; padding: 12px 22px; text-decoration:none;">
                                                                  Active account
                                                              </a>
                                                          </td>
                                                      </tr>
